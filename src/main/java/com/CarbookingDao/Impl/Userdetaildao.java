...
public class Userdetaildao {
	...
	public  String validate(UserDetail user2) throws ClassNotFoundException, SQLException {
		

		
			
		Connection Con = Connectionutil.getDBconnection();
				String log1 = "Select usertype from user_details where Email=? and cpassword=?";
			
				System.out.println("haii");
				PreparedStatement pstmt = Con.prepareStatement(log1);
				
				System.out.println(1 + user2.getEmail());
				System.out.println(2 + user2.getCpassword());
				pstmt.setString(2, user2.getEmail());
				pstmt.setString(1, user2.getCpassword());
				ResultSet rs1 = pstmt.executeQuery();
				while(rs1.next()) {
					System.out.println("rweuigheruia");
